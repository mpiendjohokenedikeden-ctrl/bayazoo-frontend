...
const styles = {
  page: { maxWidth: '900px', margin: '0 auto', padding: 'clamp(5rem, 10vw, 6rem) 2rem 4rem', minHeight: '100vh', fontFamily: "'Inter', sans-serif" },
  ...
  sousTitre: { color: '#aaa', fontSize: '0.88rem', fontFamily: "'Inter', sans-serif", marginBottom: '2rem' },
  succes: { background: '#f0faf5', color: '#2D6A4F', padding: '1rem', borderRadius: '12px', marginBottom: '1.5rem', fontWeight: '600', fontFamily: "'Inter', sans-serif", border: '1.5px solid #b7e4c7' },
  apercuGrid: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(100px, 1fr))', gap: '0.8rem', marginBottom: '2rem' },
  apercuCard: { borderRadius: '12px', padding: '0.8rem', textAlign: 'center' },
  liste: { display: 'flex', flexDirection: 'column', gap: '1rem' },
  card: { background: 'white', borderRadius: '16px', padding: '1.5rem', boxShadow: '0 2px 12px rgba(0,0,0,0.06)', display: 'flex', alignItems: 'center', gap: '1.5rem', flexWrap: 'wrap' },
  cardLeft: { display: 'flex', flexDirection: 'column', gap: '0.8rem', minWidth: '120px' },
  ...
  heures: { display: 'flex', alignItems: 'center', gap: '1rem', flex: 1 },
  heureGroup: { display: 'flex', flexDirection: 'column', gap: '0.3rem' },
  heureLabel: { fontFamily: "'Inter', sans-serif", fontSize: '0.72rem', color: '#aaa', textTransform: 'uppercase', letterSpacing: '0.05em' },
  timeInput: { padding: '0.6rem 0.8rem', borderRadius: '10px', border: '1.5px solid #e8e8ed', fontSize: '1rem', fontFamily: "'Inter', sans-serif", fontWeight: '700', color: '#0d0d0d', outline: 'none', cursor: 'pointer' },
  separateurHeure: { color: '#aaa', fontWeight: '700', marginTop: '1rem' },
  saveBtn: { background: '#E63946', color: 'white', border: 'none', padding: '0.7rem 1.4rem', borderRadius: '100px', fontWeight: '700', cursor: 'pointer', fontSize: '0.85rem', fontFamily: "'Inter', sans-serif", boxShadow: '0 4px 12px rgba(230,57,70,0.22)', marginLeft: 'auto', whiteSpace: 'nowrap' }
};
